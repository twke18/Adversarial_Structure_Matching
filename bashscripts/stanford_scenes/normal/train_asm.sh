...
# the ASM method on Stanford 2D3DS. Users could
...
SNAPSHOT_DIR=snapshots/stanford_scenes/normal/unet_asm/p512_bs8_lr${LEARNING_RATE}_adv${ADV_LAMBDA}_rec${REC_LAMBDA}_sup${SUP_LAMBDA}/${FOLD}
...
if [ ${IS_TRAIN} -eq 1 ]; then
  python3 pyscripts/train/train_stanford_scenes_asm.py\
