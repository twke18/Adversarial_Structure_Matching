...
# the CGAN baseline method on Stanford 2D3DS. Users could
...
SNAPSHOT_DIR=snapshots/stanford_scenes/normal/unet_cgan/p512_bs8_lr${LEARNING_RATE}_gan${GAN_LAMBDA}_sup${SUP_LAMBDA}/${FOLD}
...
if [ ${IS_TRAIN} -eq 1 ]; then
  python3 pyscripts/train/train_stanford_scenes_cgan.py\
